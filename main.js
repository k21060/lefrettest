...
// let name = [];
dic ={"港北ＰＡ下り" : [35.53555704142074, 139.53332974572305],"港北ＰＡ上り":[35.53289415085004, 139.5269139018005],
"海老名ＳＡ上り":[35.43219572486074, 139.39942013137994],"海老名ＳＡ下り":[35.43106801462662, 139.40144788132517],
"中井ＰＡ上り":[35.341776915770765, 139.1990086978828],"中井ＰＡ下り":[35.34312520441186, 139.20352664598278],
"鮎沢ＰＡ下り": [35.36243143193735, 139.02212629851493], "鮎沢ＰＡ上り": [35.35637673544914, 139.015778080105],
"駒門ＰＡ上り": [35.25319573434324, 138.90933539712387], "駒門ＰＡ下り": [35.2388712290444, 138.90899488316725],
"愛鷹ＰＡ上り": [35.14344830400266, 138.83645383879613],
"富士川ＳＡ上り": [35.160475646390715, 138.6180040421412],
"由比ＰＡ下り": [35.08835116272313, 138.54933454269428], "由比ＰＡ上り": [35.07808648256645, 138.54646865759585],
"日本平ＰＡ上り": [34.9835559384981, 138.43352637945742], "日本平ＰＡ下り": [34.98531398235594, 138.43548975641858],
"日本坂ＰＡ上り": [34.88970061184776, 138.3189888995843], "日本坂ＰＡ下り": [34.88911098439637, 138.3201905291815],
"牧之原ＳＡ上り": [34.761391861865334, 138.15604918014546],
"小笠ＰＡ上り": [34.761129565198296, 137.99696889849082], "小笠ＰＡ下り": [34.760698561011154, 138.00344913304633],
"遠州豊田ＰＡ下り": [34.74781361707196, 137.840383185071], 
"三方原ＰＡ上り": [34.75744924564527, 137.73823713736303], "三方原ＰＡ下り": [34.75738639327688, 137.7374622762928],
"新城ＰＡ上り": [34.84364410695155, 137.49871778315136], "新城ＰＡ下り": [34.84284257500481, 137.49823364819318], 
"豊橋ＰＡ下り": [34.84348897507361, 137.44861361198704],
"赤塚ＰＡ上り": [34.85089460760868, 137.36154975246615], "赤塚ＰＡ下り": [34.8507086486625, 137.3666326298379], 
"美合ＰＡ下り": [34.92042426582103, 137.2349143273328], "美合ＰＡ上り": [34.92654229479117, 137.22433577311236], 
"豊田上郷ＳＡ上り": [35.03264345516058, 137.1355600966519], "豊田上郷ＳＡ下り": [35.031185125451806, 137.13500219719606], 
"東郷ＰＡ上り": [35.131061456985606, 137.0844094371346], "東郷ＰＡ下り": [35.13009626195369, 137.0845167254915]
}
...
function plottimestep (mymap,data){
    ...
    let timedata = data[keys[clicktimestep]];//csv_0が持っているデータ

    for(let i=0;i<Object.keys(timedata).length;i++){//csv_0が持っているデータの数
        let placedata = Object.values(timedata)[i];
        let place = Object.keys(timedata)[i];

        if (placedata == 2) {

            placelist.push(L.marker(dic[place]).addTo(mymap));
        }
    }
}
...
// function deltimestep (mymap,data){
    ...
    //     //     }
    //     // }
    //     placelist.forEach(elem => mymap.removeLayer(elem));
    // });
// }

window.onload = (event) => {
    console.log("onload!!");
    // console.log(Object.keys(dic)[3]);
    // let p = Object.keys(dic)[3];
    // console.log(dic[p]);
    ...
    $.getJSON("test.json", (data) => {
        ...
        lb.addEventListener("click", function (e) {
            ...
            while(placelist.length){
                let elem = placelist.shift();
